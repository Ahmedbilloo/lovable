          ...
          <div className="container-page grid items-center gap-12 py-16 sm:py-24 lg:grid-cols-[1.35fr_1fr]">
            <div>
              ...
              <p className="mt-6 max-w-xl text-[15px] leading-relaxed text-muted-foreground sm:text-base">
                ...
                Python, Tableau, Power BI, and R, with a focus on dashboards, demand forecasting,
            ...
            <div className="justify-self-center lg:justify-self-end">
              <div className="flex aspect-square w-56 flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-border bg-surface sm:w-72">
        ...
        <section id="projects" className="border-b border-border bg-surface">
          <div className="container-page py-20">
            ...
            <p className="mt-4 max-w-2xl text-[15px] text-muted-foreground">
              Each project has a dedicated case study covering the problem, data, approach, and
              code.
            </p>
              ...
              {projects.map((p) => (
                ...
                >
                  <div className="flex aspect-[16/10] flex-col items-center justify-center gap-2 border-b border-border bg-surface">
                    ...
                    <p className="px-8 text-center text-[11px] text-muted-foreground">
                      Screenshot placeholder
                    </p>
                  </div>
                  <div className="flex flex-1 flex-col p-6">
                    <p className="eyebrow">{p.category}</p>
                    <h3 className="mt-2.5 text-base font-semibold tracking-tight text-balance">
                      {p.title}
                    </h3>
                    ...
                    <div className="mt-6 flex flex-wrap items-center gap-2 pt-1">
                      ...
                      {p.codeUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex items-center gap-1.5 rounded-lg border border-border px-3.5 py-2 text-sm font-medium transition-colors hover:bg-accent"
                        >
            ...
            <div className="space-y-5">
              <div className="card-surface border-primary/30 p-7">
                ...
                <p className="mt-4 text-sm text-muted-foreground">
                  Specialization: Data Analytics · Machine Learning · Statistical Modeling ·
              ...
              <div className="card-surface p-6">
                ...
                <p className="mt-1 text-sm text-muted-foreground">B.B.A.</p>
                <p className="mt-3 text-sm text-muted-foreground">Specialization: Finance</p>
              </div>
            </div>
          </div>
        </section>
